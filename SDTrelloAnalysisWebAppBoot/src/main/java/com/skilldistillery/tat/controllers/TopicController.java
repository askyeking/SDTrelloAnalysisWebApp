...
public class TopicController {
	...
	public List<Topic> findTopicsByKeywordInDateRange(@PathVariable String keyword, @PathVariable Date startDate, @PathVariable Date endDate) {
	...
	public List<Topic> findTopicsByInstructorInDateRange(@PathVariable Instructor instructor, @PathVariable Date startDate, @PathVariable Date endDate){
		return null;
	}
	
	@GetMapping("instructor/{instructor}/keyword/{keyword}")
	public List<Topic> findTopicsByInstructorAndTopicKeyword(@PathVariable Instructor instructor, @PathVariable String keyword){
